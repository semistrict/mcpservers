...
type SendControlKeysTool struct {
	...
	Keys    string  `json:"keys,required" description:"Control keys to send. Supports tmux syntax: C- (Ctrl), M- (Alt), S- (Shift), special keys (Enter, F1-F12, Up, Down, etc.). Examples: 'C-c', 'M-x', 'F1', 'Enter', 'Up Down Left Right'"`
